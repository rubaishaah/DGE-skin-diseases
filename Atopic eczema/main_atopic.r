...
data <- read.csv("C:\\Users\\pksha\\Desktop\\autoimmune\\Atopic eczema\\counts.csv", header = TRUE, row.names = 1)
info <- read.csv("C:\\Users\\pksha\\Desktop\\autoimmune\\Atopic eczema\\meta.csv", header = TRUE, sep = ",")
meta <- info
count <- data
...
venn.plot.file <- "C:\\Users\\pksha\\Desktop\\autoimmune\\Atopic eczema\\venn_diagram_DEGs.png"
...
pdf("C:\\Users\\pksha\\Desktop\\autoimmune\\Atopic eczema\\volcano_DESeq2.pdf", width = 8, height = 6)
...
pdf("C:\\Users\\pksha\\Desktop\\autoimmune\\Atopic eczema\\volcano_edgeR.pdf", width = 8, height = 6)
